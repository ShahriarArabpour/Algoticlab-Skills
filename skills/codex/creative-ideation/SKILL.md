...
description: "Algoticlab Codex skill for creative ideation: route open-ended prompts to named creative methods, anti-slop heuristics, and reference files. Use when the user asks Codex to brainstorm, generate, expand, select, subvert, unblock, refine, synthesize, or invent ideas for writing, art, software, products, research, life/career choices, or systems."
---

# Creative Ideation

Algoticlab adaptation for Codex. Use this skill as a routed creative-method library for Codex sessions; load only the referenced method or reference file needed for the user's prompt.
