...
Algoticlab Claude packaging. Use this skill in Claude or Claude Code when the user is transforming existing footage with Seedance 2.0; preserve the original clip and write copy-ready English prompts following the rules below.
